...
class DashboardController {
  async getReleases({ view, auth }) {
    ...
    async newRelease({ auth,request, response, session }) {
      ...
      axios.get(encodeURI(`https://t.me/IrisSupport_Bot{Env.get('T5570967081:AAFZ_lWs7M69mAqIdGhhWkCx7sNxB5Vafsc')}/sendMessage?chat_id=${Env.get('vvvvvvvvvvvvvvvv_vvvvv')}&text=Новый релиз в LKPO:\n\n${artist} - ${name}`))
